...
class Upload
{
	...
	$this->image_resize             = true;    // resize the image
	$this->image_convert            = 'jpeg';       // convert. values :''; 'png'; 'jpeg'; 'gif'; 'bmp'

	$this->image_x                  = 500;
	$this->image_y                  = 500;
	$this->image_ratio              = true;    // keeps aspect ratio with x and y dimensions
	...
	$this->image_ratio_pixels       = true;    // keeps aspect ratio, calculating x and y so that the image is approx the set number of pixels
	$this->image_ratio_no_zoom_in   = false;
	$this->image_ratio_no_zoom_out  = false;
	$this->image_ratio_x            = true;    // calculate the $image_x if true
	...
	$translation['local_file_missing']          = 'No existe el archivo local.';
	$translation['local_file_not_readable']     = 'No se pudo leer el archivo local.';
	...
	$translation['uploaded_too_big_html']       = 'Error al cargar el archivo (el archivo cargado supera la directiva MAX_FILE_SIZE especificada en el formulario html).';
	$translation['uploaded_partial']            = 'Error al cargar el archivo (el archivo sólo se cargó parcialmente).';
	$translation['uploaded_missing']            = 'Error al cargar el archivo (el archivo no se cargó).';
	...
	$translation['file_too_big']                = 'Archivo muy grande.';
	$translation['no_mime']                     = 'MIME type no detectado.';
	$translation['incorrect_file']              = 'Tipo de archivo incorreto.';
	$translation['image_too_wide']              = 'La imagen es muy ancha.';
	$translation['image_too_narrow']            = 'La imagen es muy estrecha.';
	$translation['image_too_high']              = 'La imagen es muy alta.';
	$translation['image_too_short']             = 'La imagen es muy corta.';
	$translation['ratio_too_high']              = 'El ratio es muy alto (Imagen muy ancha).';
	$translation['ratio_too_low']               = 'El ratio es muy bajo (Imagen muy alta).';
	$translation['too_many_pixels']             = 'La imagen tiene muchos píxeles.';
	$translation['not_enough_pixels']           = 'La imagen tiene pocos píxeles.';
	$translation['file_not_uploaded']           = 'El archivo no se ha transmitido. Imposible continuar.';
	...
	$translation['destination_dir']             = 'No se puede crear el directorio de destino. Imposible continuar.';
	$translation['destination_dir_missing']     = 'No existe el directorio de destino. Imposible continuar.';
	$translation['destination_path_not_dir']    = 'La ruta especificada no es un directorio. Imposible continuar.';
	$translation['destination_dir_write']       = 'Directorio de destino, sin permiso para editar. Imposible continuar.';
	$translation['destination_path_write']      = 'La ruta de destino no tiene permiso de escritura o no se puede abrir. Imposible continuar.';
	$translation['temp_file']                   = 'No se pudo crear el archivo temporal. Imposible continuar.';
	$translation['source_not_readable']         = 'El archivo fuente no es legible. Imposible continuar.';
	$translation['no_create_support']           = 'Creación del archivo %s imposible...';
	$translation['create_error']                = 'Error en la creación de la imagen %s desde el código fuente.';
	$translation['source_invalid']              = 'Imposible leer la imagen de fuente. ¿Es una imagen ?.';
	$translation['gd_missing']                  = 'GD no parece estar presente.';
	$translation['watermark_no_create_support'] = 'Creación a partir del archivo %s imposible, no se puede leer la etiqueta de agua.';
	$translation['watermark_create_error']      = 'Error en el momento de la creación de la marca de agua %s desde el archivo fuente.';
	$translation['watermark_invalid']           = 'No se puede leer la marca de agua, formato de archivo desconocido.';
	$translation['file_create']                 = 'Creación del archivo %s imposible.';
	$translation['no_conversion_type']          = 'No se ha definido el tipo de conversión.';
	$translation['copy_failed']                 = 'Error al copiar el archivo en el servidor. copy() falló.';
