...
final class Mysqli_Manager extends \mysqli 
{
    ...
    public function count_item($select, $from, $where = '') 
    {
    	 $contar=$this->query("SELECT {$select} FROM {$from} {$where}");
    	 return $contar->num_rows;
    }  
