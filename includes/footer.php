				...
				<div class="col-md-3">
					<div class="menu">
						...
						<div class="contenido-menu">
							<ul>
<?php 
$menu_principal = $db->select_one('*', 'm_menu', "where MENU_inTIPMENU='2' ");
 $array_menu = json_decode($menu_principal["MENU_txJSOMEN"],true);
foreach($array_menu as $obj){?>
							<li><a href="<?=$obj["href"]?>" target="<?=$obj["target"]?>"><?=$obj["text"]?></a></li>
<?php }?>
							</ul>
						</div>
					</div>
				...
				<div class="col-md-3">
					<div class="menu">
						...
						<div class="contenido-menu">
							<ul>
<?php 
$menu_principal = $db->select_one('*', 'm_menu', "where MENU_inTIPMENU='3' ");
 $array_menu = json_decode($menu_principal["MENU_txJSOMEN"],true);
foreach($array_menu as $obj){?>
							<li><a href="<?=$obj["href"]?>" target="<?=$obj["target"]?>"><?=$obj["text"]?></a></li>
<?php }?>
				...
				<div class="col-md-3">
					<div class="menu">
						...
						<div class="contenido-menu">
							<ul>
<?php 
$menu_principal = $db->select_one('*', 'm_menu', "where MENU_inTIPMENU='4' ");
 $array_menu = json_decode($menu_principal["MENU_txJSOMEN"],true);
foreach($array_menu as $obj){?>
							<li><a href="<?=$obj["href"]?>" target="<?=$obj["target"]?>"><?=$obj["text"]?></a></li>
<?php }?>
